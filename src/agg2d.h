...
//  25 Jan 2026 - Enhanced for use with Rebol3 (Oldes)
//
//----------------------------------------------------------------------------
...
public:
    ...
    struct Agg2DState
    {
        ...
        RenderType strokeType, fillType;
    };
    ...
    void fillImage(unsigned char* buf, int width, int height, int stride);
    ...
    void arrow(Color c, int head, int tail);
    ...
    void transform(double ctrX, double ctrY, double rot, double sclX ,double sclY, double trX, double trY);
    void rotate(double angle);
    void scale(double sx, double sy);
    void skew(double sx, double sy);
    void translate(double x, double y);
    void pre_rotate(double angle);
    void pre_scale(double sx, double sy);
    void pre_skew(double sx, double sy);
    void pre_translate(double x, double y);
...
private:
    ...
    agg::rendering_buffer           m_rbuf_fill;
    Image                           m_img_fill;
    ...
    bool                            m_hasStroke;
    bool                            m_hasFill;
    RenderType                      m_strokeType;
    RenderType                      m_fillType;
